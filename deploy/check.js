...
module.exports = async ({
  ...
  let vault = await deployments.get('ConvexVault');
  this.crvCvxCrvHiveVault = await deployments.get('CRVcvxCRVHiveVault');

  vault = await ethers.getContractAt('IVault', vault.address);

  console.log(await vault.earned('0x0bc5161372d5465caf72f76672c01035b219bcd7', 1));
  console.log(await vault.balanceOf('0x0bc5161372d5465caf72f76672c01035b219bcd7'));
  ...
  // console.log("LP balance: ", hre.ethers.utils.formatEther(await crvCvxCrvLpToken.balanceOf(alice)));
  ...
  // console.log("bobCRVBalance: ", bobCRVBalance.toString());
  ...
  // console.log("LP balance: ", hre.ethers.utils.formatEther(await crvCvxCrvLpToken.balanceOf(bob)));
  ...
  // console.log("charlieCRVBalance: ", charlieCRVBalance.toString());
  ...
  // console.log("LP balance: ", hre.ethers.utils.formatEther(await crvCvxCrvLpToken.balanceOf(charlie)));


}
module.exports.tags = ["check"];